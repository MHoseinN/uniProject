<template>
  <div class="min-h-screen p-6">
    <div class="max-w-6xl mx-auto">
      ...
      <!-- Users List -->
      <div class="bg-blue-50 backdrop-blur-lg rounded-2xl shadow-lg border border-white/20 overflow-hidden">
            ...
            <tbody class="divide-y divide-gray-200">
              <tr v-for="u in users" :key="u._id" class="hover:bg-gray-50 transition-colors duration-200">
                ...
                <td class="px-6 py-4">
                  <div class="gap-3">
                    <div class="text-sm font-medium text-gray-900">
                      {{ u.founded.firstName }} {{ u.founded.lastName }}
                    </div>
                  </div>
                </td>
                ...
                <td class="px-6 py-4">
                  <div class="flex justify-center gap-2">
                    <button @click="approve(u._id)" :disabled="processingUsers.has(u._id)"
                    ...
                    <button @click="reject(u._id)" :disabled="processingUsers.has(u._id)"
